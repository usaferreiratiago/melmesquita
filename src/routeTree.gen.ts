...
import { Route as PacientesImport } from './routes/clientes'
...
const PacientesRoute = PacientesImport.update({ path: '/clientes', getParentRoute: () => rootRoute } as any)
